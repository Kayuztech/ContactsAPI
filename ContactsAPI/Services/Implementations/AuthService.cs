...
namespace ContactsAPI.Services.Implementations
{
    public class AuthService : IAuthService
    {
        ...
        Task<Result<bool>> IAuthService.AssignRole(string email, string roleName)
        {
            throw new NotImplementedException();
        }

        Task<Result<LoginResponseDTO>> IAuthService.Login(LoginRequestDTO loginRequestDTO)
        {
            throw new NotImplementedException();
        }

        Task<Result<AppUserDTO>> IAuthService.Register(RegistrationRequestDTO requestDTO)
        {
            throw new NotImplementedException();
        }
